...
namespace Mango.Web.ViewModelHelpers
{
    public static class OrderViewModelHelper
    {
        ...
        /// <returns></returns>
        public static CustomerViewModel Customer(ICustomerService customerService)
        {
        ...
        /// </summary>
        public static AddressViewModel ShippingAddress(CustomerViewModel customer, IOrderService orderService)
        {
        ...
        public static int CreateOrder(Customer customer, Address shippingAddress, 
