...
namespace Mango.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : Mango.Admin.Controllers.UserController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Mango.Admin.Models.UserViewModel vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Mango.Admin.Models.UserViewModel vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
