...
namespace Mango.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductController : Mango.Admin.Controllers.ProductController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Mango.Admin.ViewModels.ProductFormViewModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Mango.Admin.ViewModels.ProductFormViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
